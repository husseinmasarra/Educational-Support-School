...
export const ArchiveModule = () => {
 ...
 if (clearAllArchives) {
 clearAllArchives();
 setToastMsg('تم مسح وتفريغ كافة السجلات والأعوام المؤرشفة التجريبية بنجاح! ');
 setTimeout(() => setToastMsg(''), 4000);
 }
 }
 };
 ...
 setToastMsg(`تم حذف أرشيف العام الدراسي (${arch.yearName}) نهائياً بنجاح! `);
 setTimeout(() => setToastMsg(''), 4000);
 }
 }
 };
 ...
 <span>مسح وتفريغ الأرشيف التجريبي </span>
 </button>
 )}
 <button
 ...
 title="حذف هذا العام الدراسي من الأرشيف نهائياً "
 >
 ...
 >
 <Trash2 className="w-4 h-4" />
 <span>حذف هذا العام نهائياً من المنظومة </span>
 </button>
 )}
 <button
