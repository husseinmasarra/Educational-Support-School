...
export const ClassesModule = ({ initialSubTab = 'grades' }) => {
 ...
 if (isDuplicate) {
 alert(isAr ? 'هذه الشعبة مضافة بالفعل لهذا الصف الدراسي!' : 'This section already exists for this grade!');
 return;
 }
 ...
 {isAr ? 'تم إضافة جميع الشعب الـ 5 مسبقاً!' : 'All 5 sections added!'}
 </div>
 ) : (
 <select
 required
