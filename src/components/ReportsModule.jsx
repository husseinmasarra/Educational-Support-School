...
export const ReportsModule = () => {
 ...
 كشف درجات وشهادة تقويم رسمية </div>
 ...
 <span className="text-lg font-bold text-[#0F172A]">${selectedStudent.tuitionTotal || 700} USD</span>
 </div>
 <div className="bg-[#F8FAFC] p-4 rounded-2xl border border-[#E2E8F0]">
 ...
 {selectedStudent.frozen ? 'مجمد (معفى من المتأخرات)' : `$${(selectedStudent.tuitionTotal || 700) - (selectedStudent.tuitionPaid || 0)} USD`}
 </span>
 </div>
 </div>
 </div>
