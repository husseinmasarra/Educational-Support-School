...
export const StudentCardModal = ({ student, onClose }) => {
 ...
 <h3 className="text-xs sm:text-sm font-black text-white truncate leading-tight flex items-center gap-1">
 <span>{lang === 'ar' ? student.name : student.nameEn}</span>
 {student.isSpecialCase && <span className="text-amber-400 font-black text-sm" title="حالة خاصة">⭐</span>}
 </h3>
